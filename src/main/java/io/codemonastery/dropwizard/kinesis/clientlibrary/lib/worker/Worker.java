...
import io.codemonastery.dropwizard.kinesis.clientlibrary.proxies.KinesisProxyFactory;
import io.codemonastery.dropwizard.kinesis.clientlibrary.types.ShutdownReason;
import io.codemonastery.dropwizard.kinesis.leases.exceptions.LeasingException;
import io.codemonastery.dropwizard.kinesis.leases.impl.KinesisClientLeaseManager;
import io.codemonastery.dropwizard.kinesis.metrics.impl.CWMetricsFactory;
import io.codemonastery.dropwizard.kinesis.metrics.impl.NullMetricsFactory;
...
public class Worker implements Runnable {
     ...
     */
    public Worker(
            io.codemonastery.dropwizard.kinesis.clientlibrary.interfaces.IRecordProcessorFactory recordProcessorFactory,
    ...
    public static class Builder {
        ...
        /**
         * Provide a V1
         * {@link io.codemonastery.dropwizard.kinesis.clientlibrary.interfaces.IRecordProcessor IRecordProcessor}.
         *
         * @param recordProcessorFactory Used to get record processor instances for processing data from shards
         * @return A reference to this updated object so that method calls can be chained together.
         */
        public Builder recordProcessorFactory(
                io.codemonastery.dropwizard.kinesis.clientlibrary.interfaces.IRecordProcessorFactory
        ...
        /**
         * Provide a V2
         * {@link IRecordProcessor IRecordProcessor}.
         *
         * @param recordProcessorFactory Used to get record processor instances for processing data from shards
         * @return A reference to this updated object so that method calls can be chained together.
         */
